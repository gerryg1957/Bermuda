...
use moyodb::{Board, Colour, project_manager::ProjectManager};
...
impl ffi::MoyoDbApp {
    fn load_game(mut self: Pin<&mut Self>, project_path: &QString, game_id: i64) -> bool {
        self.as_mut().load_position(project_path, game_id, 0)
    }
    ...
    fn show_position(
        ...
        self.as_mut()
            .load_position(project_path, game_id, move_number)
    }
    ...
    fn load_position(
        ...
        let result = load_position_data(&path, game_id, move_number);
